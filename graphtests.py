...
class TestGraph(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_graph = {}
        self.test_pos = {}
        self.load = GraphSearch()

    def tearDown(self):
        del self.load

    def test_graph1(self):
        self.load.load_from_file(self.graph_dir + "graph1.txt")
        self.test_graph['A'] = [['B', 1]]
        self.test_graph['B'] = [['C', 2]]
        self.test_graph['C'] = [['D', 3]]
        self.assertEqual(cmp(self.test_graph, self.load._graph), 0)
        # print("Graph1 test passed")

    def test_graph2(self):
        self.load.load_from_file(self.graph_dir + "graph2.txt")
    ...
    def test_graph3(self):
        self.load.load_from_file(self.graph_dir + "graph3.txt")
        self.test_graph['A'] = [['B', 1]]
        self.test_graph['B'] = [['C', 2]]
        self.test_graph['C'] = [['D', 3], ['E', 4]]
    ...
    def test_graph4(self):
        self.load.load_from_file(self.graph_dir + "graph4.txt")
        self.test_graph['A'] = [['B', 1], ['E', 16]]
    ...
    def test_graph5(self):
        self.load.load_from_file(self.graph_dir + "graph5.txt")
    ...
    def test_graph6(self):
        self.load.load_from_file(self.graph_dir + "graph6.txt")
    ...
    def test_graph7(self):
        self.load.load_from_file(self.graph_dir + "graph7.txt")
    ...
    def test_graph8(self):
        self.load.load_from_file(self.graph_dir + "graph8.txt")
        self.test_graph['A'] = [['B', 1, 1, 0], ['E', 4, 1, 0]]
        self.test_graph['B'] = [['C', 2, 3, 0]]
        self.test_graph['C'] = [['D', 3, 4, 0], ['E', 4, 1, 0]]
        self.assertEqual(cmp(self.test_graph, self.load._graph), 0)
        ...
        self.assertEqual(cmp(self.test_pos, self.load._node_pos), 0)

    def test_graph9(self):
        self.load.load_from_file(self.graph_dir + "graph9.txt")
        self.test_graph['A'] = [['B', 1, 1, 0], ['E', 4, 1, 0]]
        self.test_graph['B'] = [['C', 2, 3, 0]]
    ...
    def test_graph10(self):
        self.load.load_from_file(self.graph_dir + "graph10.txt")
    ...
    def test_graph11(self):
        self.load.load_from_file(self.graph_dir + "graph11.txt")
        self.test_graph['A'] = [['B'], ['E']]
        self.test_graph['B'] = [['C']]
        self.test_graph['C'] = [['D'], ['E']]
        self.assertEqual(cmp(self.test_graph, self.load._graph), 0)
    ...
    def test_graph12(self):
        with self.assertRaises(GraphSearch.NodeParseError):
            self.load.load_from_file(self.graph_dir + "graph12.txt")

    def test_graph13(self):
        self.load.load_from_file(self.graph_dir + "graph13.txt")
        self.test_graph['A'] = [['B'], ['E']]
        self.test_graph['B'] = [['C']]
        self.test_graph['C'] = [['D'], ['E']]
        self.assertEqual(cmp(self.test_graph, self.load._graph), 0)
        self.test_pos['A'] = [0, 0, 0]
        self.test_pos['B'] = [1, 1, 1]
        self.test_pos['C'] = [2, 2, 2]
        self.test_pos['D'] = [3, 3, 3]
        self.test_pos['E'] = [4, 4, 4]
        self.assertEqual(cmp(self.test_graph, self.load._graph), 0)
